...
Route::middleware('auth')->group(function () {
     ...
     Route::group(['prefix' => 'jurusan'], function () {
          ...
          Route::group(['prefix' => 'kurikulum'], function () {
               Route::get('/', [App\Http\Controllers\KurikulumController::class, 'index'])->name('jurusan.kurikulum');
               Route::get('/data', [App\Http\Controllers\KurikulumController::class, 'data']);
               Route::post('/create', [App\Http\Controllers\KurikulumController::class, 'create']);
               Route::get('/edit/{id}', [App\Http\Controllers\KurikulumController::class, 'edit']);
               Route::post('/update/{id}', [App\Http\Controllers\KurikulumController::class, 'update']);
               Route::get('/delete/{id}', [App\Http\Controllers\KurikulumController::class, 'delete']);
          });
          ...
          Route::group(['prefix' => 'kategori-penilaian-dokumen'], function () {
               Route::get('/', [App\Http\Controllers\BerkasController::class, 'penilaian_index'])->name('jurusan.kategori_penilaian_dokumen');
          ...
          Route::group(['prefix' => 'kategori-penilaian-soal'], function () {
               Route::get('/', [App\Http\Controllers\BerkasController::class, 'penilaian_soal_index'])->name('jurusan.kategori_penilaian_soal');
               Route::get('/data', [App\Http\Controllers\BerkasController::class, 'penilaian_soal_data']);
               Route::post('/create', [App\Http\Controllers\BerkasController::class, 'penilaian_soal_create']);
               Route::get('/edit/{id}', [App\Http\Controllers\BerkasController::class, 'penilaian_soal_edit']);
               Route::post('/update/{id}', [App\Http\Controllers\BerkasController::class, 'penilaian_soal_update']);
               Route::get('/delete/{id}', [App\Http\Controllers\BerkasController::class, 'penilaian_soal_delete']);
          });
     ...
     Route::get('/soal-uas/{id}', [App\Http\Controllers\BerkasController::class, 'soal_uas']);
